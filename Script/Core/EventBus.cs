...
// ═══════════════════════════════════════════
//  Rebind 事件（输入系统 ↔ UI 通信）
// ═══════════════════════════════════════════

/// <summary>UI 请求重绑定某个 Action</summary>
public struct RebindRequestEvent {
    public string actionName;
    public string mapName;
}

/// <summary>InputManager 开始重绑定</summary>
public struct RebindStartEvent {
    public string actionName;
}

/// <summary>重绑定完成</summary>
public struct RebindCompleteEvent {
    public string actionName;
    public string newBindingDisplay;
}

/// <summary>重绑定取消</summary>
public struct RebindCancelEvent {
    public string actionName;
}

/// <summary>通用输入动作触发（瘦身后的统一事件）</summary>
